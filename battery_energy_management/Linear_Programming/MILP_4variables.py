...
if __name__ == '__main__':
    ...
    if forecasts_correction == False:
        results_df.to_csv(f'results_GUROBI_(no_correction)_MILP.csv')
        my_average_function(f'results_GUROBI_(no_correction)_MILP')
    else:
        results_df.to_csv(f'results_GUROBI_(with_correction)_MILP.csv')
        my_average_function(f'results_GUROBI_(with_correction)_MILP')
